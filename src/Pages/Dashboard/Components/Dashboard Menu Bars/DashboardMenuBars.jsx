        ...
        <div>
            <div className='grid md:grid-cols-1 grid-cols-3 text-center md:text-left my-6 md:ml-2'>
                <div className="dropdown dropdown-hover my-2">
                    <label tabIndex={0} className="text-xl text-primary">Buyer</label>
                ...
                <div className="dropdown dropdown-hover my-2">
                    <label tabIndex={0} className="text-xl text-primary">Seller</label>
                    <ul tabIndex={0} className="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52">
                ...
                <div className="dropdown dropdown-hover my-2">
                    <label tabIndex={0} className="text-xl text-primary">Admin</label>
                    <ul tabIndex={0} className="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52">
